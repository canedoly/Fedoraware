...
public:
	...
	virtual void AddBoxOverlay3(const Vec3& origin, const Vec3& mins, const Vec3& max, Vec3 const& orientation, const Color_t& faceColor, const Color_t& edgeColor, float duration) = 0;
