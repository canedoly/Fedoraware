...
int CCritHack::NextCritTick(const CUserCmd* pCmd, int loops = (Vars::CritHack::CritLoops.m_Var))
{
...
/* this crithack kinda pasted bro
#include "CritHack.h"
#define MASK_SIGNED 0x7FFFFFFF
...
void CCritHack::Draw()
{
	...
	{
		g_Draw.String(FONT_INDICATORS, g_ScreenSize.c, currentY += 15, { 181, 181, 181, 255}, ALIGN_CENTERHORIZONTAL, "Server disabled crits");
	}
	else
	{
		// Are we currently forcing crits?
