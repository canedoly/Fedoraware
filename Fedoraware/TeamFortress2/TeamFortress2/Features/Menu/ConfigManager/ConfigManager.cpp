	...
	try
	{
		...
		//Misc
		{
			...
			// CL_Move
			{
				...
				SAVE_VAR(Vars::Misc::CL_Move::WarpSpeed);
				...
				//SAVE_OTHER(Vars::Misc::CL_Move::RijinBG);
		...
		//AntiHack
		{
			//AntiAim
			{
				...
				SAVE_VAR(Vars::AntiHack::AntiAim::StaticOffset);
				SAVE_VAR(Vars::AntiHack::AntiAim::StaticOffsetF);
	...
	try
	{
		...
		//Misc
		{
			...
			// CL_Move
			{
				...
				LOAD_VAR(Vars::Misc::CL_Move::WarpSpeed);
				...
				//LOAD_OTHER(Vars::Misc::CL_Move::RijinBG);
		...
		//AntiHack
		{
			//AntiAim
			{
				...
				LOAD_VAR(Vars::AntiHack::AntiAim::StaticOffset);
				LOAD_VAR(Vars::AntiHack::AntiAim::StaticOffsetF);
